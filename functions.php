...
function learnwp_editor_styles(){
	wp_enqueue_style( 'gutenberg-editor-styles', get_template_directory_uri() . '/css/style-editor.css' ); 
	wp_enqueue_style( 'lato', 'https://fonts.googleapis.com/css?family=Lato:400,900' ); 
	wp_enqueue_style( 'oswald', 'https://fonts.googleapis.com/css?family=Oswald:200,400,900');
}
add_action( 'enqueue_block_editor_assets', 'learnwp_editor_styles' );
